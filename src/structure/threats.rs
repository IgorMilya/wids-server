// Threat structures (currently commented out in main.rs)
// Uncomment and use when threats feature is re-enabled

use mongodb::bson::{DateTime, oid::ObjectId};
use serde::{Deserialize, Serialize};
use crate::utils::serialize_datetime_as_iso_string;

#[allow(dead_code)] // For future use when threats feature is enabled
